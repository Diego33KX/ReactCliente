          ...
          <ul className="nav-links">
            ...
            <li><a href="#">CLIENTES</a></li>
             ...
             
                  {
                    (currentUser)?
                    <li>
                    <Link to={"/historial"} onClick={()=>{getHistorial(currentUser.username)}}>Historial</Link>
                  </li>:<li></li>
                  
              }
              {
                    (currentUser)?
                    <li><i class="bi bi-person-circle"><strong>{currentUser.username}</strong></i></li>
                    :<li></li>
                  } 
            <li>
            ...
            <li>
                  ...
                  {
                    (!currentUser)?
                    <Link   to={'/login'}><i class="bi bi-person-circle"> Ingresar</i></Link>:
